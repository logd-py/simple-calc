# program to print fibonaci series of numbers per user requested number of terms.

from matplotlib.patches import Arc
import matplotlib.pyplot as plt
#Welcome message

print("Hello! Welcome to Fibonacci Series generator program")
print("########Designed by Nightfury########")

#get input from user
nterms=int(input("please enter the number of terms for fibonacci series :"))
...
if nterms==0:
    print("please enter a positive number to generate series")
elif nterms==1:
